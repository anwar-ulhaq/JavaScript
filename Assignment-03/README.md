...
### Task A
  * Create an AJAX application which fetches HTML-document and displays it on web page
...
### Task B
  * Create an AJAX application which fetches data from JSON-document and displays it on web page
